  ...
  func.func @main() {
    ...
    emitc.for %arg0 = %17 to %18 step %19 {
      emitc.for %arg1 = %17 to %18 step %19 {
        metal.store %15, %5, %arg0, %arg1[%3, %4] : f32, index, index, index, i64, i64
        metal.store %16, %9, %arg0, %arg1[%7, %8] : f32, index, index, index, i64, i64
      }
    }
    %20 = "emitc.constant"() <{value = 32 : ui32}> : () -> ui32
    %21 = "metal.matmul"(%1, %5, %3, %4, %9, %7, %8, %13, %20) <{operandSegmentSizes = array<i32: 1, 1, 1, 1, 1, 1, 1, 1, 1>}> : (index, index, i64, i64, index, i64, i64, index, ui32) -> index
    return
  }
}
