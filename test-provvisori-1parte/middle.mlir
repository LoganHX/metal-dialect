module attributes {gpu.container_module} {
  func.func @main() {
    ...
    %8 = metal.device_make_buffer %0, %6, %7 x f32 : (index, i1, i64) -> index
    %alloc = memref.alloc() : memref<10xf32>
    %9 = "emitc.constant"() <{value = 1 : index}> : () -> index
    %10 = "emitc.constant"() <{value = 10 : index}> : () -> index
    %11 = metal.command_queue_make_command_buffer main_kernel %1, %10, %9, %9: (index, index, index, index) -> index
    %12 = "emitc.constant"() <{value = 0 : i64}> : () -> i64
    metal.command_buffer_add_buffer %11, %8, %12 : (index, index, i64) -> ()
    metal.command_buffer_commit %11 : index
    metal.command_buffer_wait_until_completed %11 : index
    metal.release %11 : index
    memref.store %5, %alloc[%3] : memref<10xf32>
    %13 = "metal.castptr"(%8) : (index) -> memref<10xf32>
    call @foo(%13) : (memref<10xf32>) -> ()
    return
  }
  ...
  func.func @foo(%arg0: memref<10xf32>) {
    ...
    %3 = "emitc.constant"() <{value = 2.110000e+01 : f32}> : () -> f32
    memref.store %3, %arg0[%2] : memref<10xf32>
    return
  }
}
