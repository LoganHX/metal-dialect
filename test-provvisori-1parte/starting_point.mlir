func.func @main() {
  %A = gpu.alloc() : memref<4x4xf32>
  %B = gpu.alloc() : memref<4x4xf32>
  %C = gpu.alloc() : memref<4x4xf32>
...
//   gpu.dealloc %GPU : memref<10xf32>
//   memref.dealloc %CPU : memref<10xf32>
...
//   %A = gpu.alloc() : memref<10xf32>
//   scf.parallel (%i) = (%c1) to (%c2) step (%step) {
//     memref.store %value, %A[%i] : memref<10xf32>
//   }
//   gpu.dealloc %A : memref<10xf32>
