module attributes {gpu.container_module} {
  func.func @main() {
    ...
    gpu.launch_func  @main_kernel::@main_kernel blocks in (%7, %8, %6) threads in (%6, %6, %6)  args(%alloc : memref<40000x40000xf32>)
    %9 = "emitc.constant"() <{value = 1 : index}> : () -> index
    %10 = "emitc.constant"() <{value = 40000 : index}> : () -> index
    %11 = "emitc.constant"() <{value = 40000 : index}> : () -> index
    gpu.launch_func  @main_kernel_0::@main_kernel blocks in (%10, %11, %9) threads in (%9, %9, %9)  args(%alloc : memref<40000x40000xf32>)
    memref.dealloc %alloc : memref<40000x40000xf32>
    return
  }
  gpu.module @main_kernel {
    gpu.func @main_kernel(%arg0: memref<40000x40000xf32>) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>} {
      ...
      %2 = "emitc.constant"() <{value = 0.000000e+00 : f32}> : () -> f32
      memref.store %2, %arg0[%block_id_x, %block_id_y] : memref<40000x40000xf32>
      gpu.return
    }
  }
  gpu.module @main_kernel_0 {
    gpu.func @main_kernel(%arg0: memref<40000x40000xf32>) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>} {
      ...
      %7 = memref.load %arg0[%block_id_x, %block_id_y] : memref<40000x40000xf32>
      %8 = emitc.add %6, %7 : (f32, f32) -> f32
      memref.store %8, %arg0[%block_id_x, %block_id_y] : memref<40000x40000xf32>
      gpu.return
    }
  }
