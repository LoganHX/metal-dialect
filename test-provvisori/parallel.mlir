module attributes {gpu.container_module} {
  func.func @main() {
    ...
    %alloc = memref.alloc() : memref<42xf32>
    memref.store %4, %alloc[%2] : memref<42xf32>
    %5 = memref.load %alloc[%2] : memref<42xf32>
    %6 = "emitc.constant"() <{value = 1 : index}> : () -> index
    %7 = "emitc.constant"() <{value = 10 : index}> : () -> index
    gpu.launch_func  @main_kernel::@main_kernel blocks in (%7, %6, %6) threads in (%6, %6, %6)  args(%alloc : memref<42xf32>)
    memref.dealloc %alloc : memref<42xf32>
    return
  }
  gpu.module @main_kernel {
    gpu.func @main_kernel(%arg0: memref<42xf32>) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>} {
      ...
      %3 = "emitc.constant"() <{value = 12 : index}> : () -> index
      memref.store %2, %arg0[%block_id_x] : memref<42xf32>
      %4 = memref.load %arg0[%3] : memref<42xf32>
      gpu.return
    }
  }
}
