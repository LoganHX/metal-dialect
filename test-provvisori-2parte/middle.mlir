module {
  func.func @main() {
    ...
    %6 = "emitc.constant"() <{value = 4 : i64}> : () -> i64
    ...
    emitc.for %arg0 = %2 to %1 step %0 {
      emitc.for %arg1 = %2 to %1 step %0 {
        %23 = "emitc.constant"() <{value = 0 : ui32}> : () -> ui32
        %24 = "emitc.constant"() <{value = 4 : ui32}> : () -> ui32
        %25 = "emitc.constant"() <{value = 4 : ui32}> : () -> ui32
        %26 = "emitc.constant"() <{value = 1 : ui32}> : () -> ui32
        metal.store %3, %9[%arg0 : %24] [%arg1 : %25] [%23 : %26] : i32, index, index, index, ui32, ui32, ui32, ui32
      }
    }
    ...
    emitc.for %arg0 = %2 to %1 step %0 {
      emitc.for %arg1 = %2 to %1 step %0 {
        ...
        %25 = "emitc.constant"() <{value = 4 : ui32}> : () -> ui32
        %26 = "emitc.constant"() <{value = 1 : ui32}> : () -> ui32
        metal.store %3, %14[%arg0 : %24] [%arg1 : %25] [%23 : %26] : i32, index, index, index, ui32, ui32, ui32, ui32
      }
    }
    %15 = "emitc.constant"() <{value = false}> : () -> i1
    %16 = "emitc.constant"() <{value = 4 : i64}> : () -> i64
    %17 = "emitc.constant"() <{value = 4 : i64}> : () -> i64
    ...
    %22 = metal.matmul %21, %9<%6 : %7> %14<%11 : %12> %19, %20 : index, index, i64, i64, index, i64, i64, index, ui32
    return
  }
}
